# Remediation - Create metric filter and alarm for CloudTrail configuration changes should be configured
 ...
 * [CloudWatch] It's a pre-requisite, it creates required policies, logs group, role and S3 bucket to push logs.
 * [CloudWatch] Create metric filter and alarm for CloudTrail configuration changes should be configured 
